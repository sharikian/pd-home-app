...
import Kargah from "./imgs/kargah.png";
    ...
    <div className="flex flex-col items-center w-full">
      <div className="w-full flex justify-between gap-8">
        ...
        <div className="relative w-full max-w-[calc(50%-16px)] h-[40vh] rounded-[2%]">
          <div
            className={`absolute inset-0 rounded-[2%] bg-[url(${Events})] bg-cover bg-[50%_50%]`}
          />
        ...
        <div className="relative w-full max-w-[calc(50%-16px)] h-[40vh] rounded-[2%]">
          <div
            className={`absolute inset-0 rounded-[2%] bg-[url(${Kargah})] bg-cover bg-[50%_50%]`}
          />
