          ...
          <div className="w-full px-2 md:px-4 lg:px-8">
            <div className="flex flex-col items-center gap-4 md:gap-6">
              <Tabs
                ...
                items={[
                  { value: "ارجاعات", activate: true, link: '/' },
                  { value: "برنامه من", activate: false, link: '/myplan' },
                ]}
              />
              <div
                className="rounded-[1.5rem] md:rounded-[2.1875rem] p-3 md:p-6 lg:p-8 border border-[#00000010] bg-white w-full md:scale-90 md:mt-[-2rem]
