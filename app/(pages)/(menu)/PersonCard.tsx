...
export const PersonCard = () => {
  return (
    <div
      className="flex flex-col py-[20px] px-3.5 rounded-[15px] bg-[#B9D0AA]"
      style={{ width: "370px" }}
    >
      <Image src={Rectangle} alt="person card" />
      <div className="flex flex-col justify-between">
        <div className="inline-flex flex-col items-end gap-2.5 mt-2">
