...
import { Chip } from "../../(user)/(tavan)/myplan/Chip";
import { useState } from "react";
import { Calendar } from "react-multi-date-picker";
import gregorian_fa from "react-date-object/locales/gregorian_fa";
import { Input, Button } from "@/app/components/";
import { CheckBox } from "@/app/components/ui/CheckBox";
import Modal from "../../(user)/(tavan)/myplan/Modal";
import DangerModal from "../../(user)/(tavan)/myplan/DangerModal";
import { Helpers } from "../../(user)/(tavan)/myplan/Helpers";
...
const MegaCalendar = () => {
  ...
  const events = [
    {
      start: "2025-04-08", // CT Scan on 17th
      chipText: "CT",
      icon: BloodIcon,
          ...
          <div className="grid grid-rows-[auto] lg:grid-rows-[10%_40%_50%] gap-2 h-full relative">
            ...
            >
              <button
                ...
                onClick={() =>
                  setSelectedEvent({ extendedProps: { chipText: "Add Event" } })
                }
