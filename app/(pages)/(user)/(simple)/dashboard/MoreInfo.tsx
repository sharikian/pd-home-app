...
import Events from '@/public/imgs/menu/events.png'
import Kargah from '@/public/imgs/menu/kargah.png'
  ...
  return (
    <div className="w-full flex flex-col lg:flex-row gap-4 md:gap-8">
      ...
      <div className="relative w-full lg:w-1/2 h-[300px] md:h-[40vh] rounded-xl md:rounded-2xl overflow-hidden">
        <div className="absolute inset-0 bg-cover bg-center" style={{backgroundImage: `url(${Events.src})`}} />
      ...
      {/* Card 2 */}
      <div className="relative w-full lg:w-1/2 h-[300px] md:h-[40vh] rounded-xl md:rounded-2xl overflow-hidden">
        <div className="absolute inset-0 bg-cover bg-center" style={{backgroundImage: `url(${Kargah.src})`}} />
